                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onmouseover="viewProductModal('<?php echo $selected_data['id']; ?>');">
                            ...
                            ?><img src="<?php echo $image_data["img_path"]; ?>" style="height: 40px;margin-left: 80px;" /><?php
                                                                                                                                                                                                                    }
                                                                                                                                                                                                                        ?>
                        </div>
                        <div class="col-4 col-lg-2 bg-primary py-2">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="offset-4 col-4">
                                    <?php
                                    $image_rs2 = Database::search("SELECT * FROM `product_img` WHERE `product_id`='" . $selected_data["id"] . "'");
