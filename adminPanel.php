                    ...
                    <div class="row">
                                    ...
                                    <div class="row g-1">
                                        <div class="col-12 bg-primary text-white text-center rounded" style="height: 100px;">
                                            ...
                                            for ($x = 0; $x < $invoice_num; $x++) {
                                                ...
                                                $d = $invoice_data["date"];
                                                $splitDate = explode(" ", $d);  //seperate the date from time
                                                ...
                                                $splitMonth = explode("-", $pdate);  //seperate date as year, month and day
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                $freq_rs = Database::search("SELECT `product_id`,COUNT(`product_id`) AS `value_occurance` FROM `invoice`
                                WHERE `date` LIKE '%" . $today . "%' GROUP BY `product_id` ORDER BY `value_occurance` DESC LIMIT 1");
                                ...
                                if ($freq_num > 0) {
                                    ...
                                    product.id=product_img.product_id INNER JOIN `user` ON product.user_email=user.email INNER JOIN 
                                    `profile_img` ON user.email=profile_img.user_email WHERE `id`='" . $freq_data["product_id"] . "'");
                                ...
                                ?>
                                    <div class="col-12 text-center shadow">
                                        <img src="<?php echo $product_data["img_path"]; ?>" class="img-fluid rounded-top" style="height: 250px;" />
                                    </div>
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center shadow">
                                        <img src="<?php echo $product_data["path"]; ?>" class="img-fluid rounded-top" style="height: 250px;" />
                                    </div>
                                    <div class="col-12 text-center my-3">
                                        <span class="fs-5 fw-bold"><?php echo $product_data["fname"]." ".$product_data["lname"]; ?></span><br />
                                        <span class="fs-6"><?php echo $product_data["email"]; ?></span><br />
                                        <span class="fs-6"><?php echo $product_data["mobile"]; ?></span>
                                    </div>
                                <?php
                                } else {
                                ?>
