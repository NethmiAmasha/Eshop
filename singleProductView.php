                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3 bg-white">
                                <div class="row">
                                    ...
                                    `model_has_brand_id`='" . $product_data["model_has_brand_id"] . "' AND `status_status_id`='1' LIMIT 5");
                                                ...
                                                <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                                    ...
                                                    <div class="card-body ms-0 m-0 text-center">
                                                        ...
                                                        ?>
                                                            ...
                                                            <span class="card-text text-success fw-bold"><?php echo $related_data["qty"]; ?> Items Available</span><br /><br />
                                                            <a href='<?php echo "singleProductView.php?id=" . ($related_data["id"]); ?>' class="col-12 btn btn-success">Buy Now</a> 
                                        ...
                                        <div class="row border border-1 border-dark rounded me-0">
                                            ...
                                            <div class="col-2 mt-1 mb-1 me-0">
                                                ...
                                                if($feedback_data["type"]==1){
                                                    ...
                                                    ?><span class="badge bg-success">Neutral</span><?php
                                                }else if($feedback_data["type"]==3){
                                                    ?><span class="badge bg-success">Negative</span><?php
                                                }
                                                ?>
                                            </div>
