                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <div class="message_box" id="message_box">
                                                ...
                                                user.email=profile_img.user_email WHERE `email`='" . $sender . "'");
                                                        ...
                                                        <div class="list-group rounded-0" onclick="viewMessage('<?php echo $sender; ?>');">
                                                            <a href="#" class="list-group-item list-group-item-action text-dark rounded-0 bg-body">
                                                                ...
                                                                <div class="media">
                                                                    ...
                                                                    <div class="me-4">
                                                                        <div class="d-flex align-items-center justify-content-between mb-1 ">
                                                                            <h6 class="mb-0 fw-bold"><?php echo $msg_data["receiver"]; ?></h6>
                                                                            <small class="small fw-bold"><?php echo $msg_data["date_time"]; ?></small>
                        ...
                        <div class="col-12 px-2">
                            <div class="row">
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-light fs-2" id="send_btn"><i class="bi bi-send-fill fs-1" onclick="send_msg();"></i></button>
                                </div>
                            </div>
                        </div>
                        <!-- txt -->
