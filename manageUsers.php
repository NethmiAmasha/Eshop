                    ...
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewMsgModal('<?php echo $selected_data['email']; ?>');">
                            ...
                            if($profile_img_num==1){
                                ...
                                ?><img src="<?php echo $profile_img_data["path"]; ?>" style="height: 40px;margin-left: 80px;" /><?php
                            }else{
                                ?><img src="resource/new_user.svg" style="height: 40px;margin-left: 80px;" /><?php
                            }
                            ?>
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            if($selected_data["status_status_id"]==1){
                                ?><button id="ub<?php echo $selected_data["email"]; ?>" class="btn btn-danger" 
                                onclick="blockUser('<?php echo $selected_data['email']; ?>');">Block</button><?php
                            }else{
                                ?><button id="ub<?php echo $selected_data["email"]; ?>" class="btn btn-success"
                                onclick="blockUser('<?php echo $selected_data['email']; ?>');">Unblock</button><?php
                            }
                            ?>
                            ...
                            <div class="modal-footer">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-3 d-grid">
                                            <button type="button" class="btn btn-primary" onclick="sendAdminMsg('<?php $selected_data['email']; ?>');">Send</button>
                                        </div>
                                    </div>
                                </div>
